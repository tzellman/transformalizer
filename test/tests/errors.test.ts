...
import createTransformalizer, { Schema } from '../../lib';
...
describe('errors and coverage', function () {
    describe('#register', function () {
        it('should throw if the name is invalid', function () {
            ...
            expect(() => transformalizer.register({ name: (null as unknown) as string })).to.throw(Error);
        });
    });
    ...
    describe('#transform', function () {
        ...
        it('should throw if the name is invalid', function () {
            expect(() => transformalizer.transform({ name: (null as unknown) as string })).to.throw(Error);
        });

        it('should throw if the schema does not exist', function () {
            expect(() => transformalizer.transform({ name: 'missing' })).to.throw(Error);
        });
        ...
        it('should throw if type returns a non string', function () {
            ...
            expect(() => transformalizer.transform({ name: 'invalid-type', source: {} })).to.throw(Error);
        });
        ...
        it('should throw if id returns a non string', function () {
            ...
            expect(() => transformalizer.transform({ name: 'invalid-id', source: {} })).to.throw(Error);
        });
        ...
        it('should skip attributes if they return a non object', function () {
            ...
            expect(transformalizer.transform({ name: 'no-attributes', source: { id: 1 } }))
                ...
                .that.is.an('object');
            expect(
                transformalizer.transform({ name: 'no-attributes', source: { id: 1, skip: true } })
        ...
        it('should skip a relationship if it returns a non object', function () {
            ...
            expect(
                transformalizer.transform({ name: 'no-relationships', source: { id: 1 } })
            ...
            expect(transformalizer.transform({ name: 'no-relationships', source: { id: 1, thing: { id: 1 } } }))
                .to.have.deep.property('data.relationships')
                .with.all.keys('thing');
        });
        ...
        it('should skip a relationship if it returns invalid data only', function () {
            ...
            expect(
                transformalizer.transform({ name: 'invalid-relationship-data', source: { id: 1 } })
            ).to.not.have.deep.property('data.relationships');
        });
        ...
        it('should support relationship meta', function () {
            ...
            expect(transformalizer.transform({ name: 'relationship-meta', source: { id: 1 } })).to.have.deep.property(
                'data.relationships.thing.meta.count'
            );
        });
        ...
        it('should throw if relationship data includes a missing schema name', function () {
            ...
            expect(() => transformalizer.transform({ name: 'unknown-relationship-name', source: { id: 1 } })).to.throw(
                Error
            );
        });
        ...
        it('should throw if relationship data includes an invalid schema name', function () {
            ...
            expect(() => transformalizer.transform({ name: 'invalid-relationship-name', source: { id: 1 } })).to.throw(
                Error
            );
        });
        ...
        it('should throw not throw if no attributes hook present', function () {
            ...
            expect(() =>
                transformalizer.transform({ name: 'transform-no-attributes', source: { id: 1 } })
            ).to.not.throw(Error);
        });
    });
});
